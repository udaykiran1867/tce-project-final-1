...
import { BarChart3, LogOut, Search, Menu, X, Package, FileText, NotebookText, ClipboardList } from "lucide-react"
...
export function Navbar() {
  ...
  const navLinks = [
    ...
    { href: "/dashboard/multirecord", label: "Multirecord", icon: ClipboardList },
